			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-12">
								<h2><b>Para saan ba ang site na eto?<b></h2>
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<p>-Talang buhay ng mga ating lugar</p>
						<p>-Malaman naten kahalagahan</p>
						<p>-Dahil "Nagiging banyaga tayo sa sarili nating bansa".</p>
						<p>-Mga katangian ng pinoy</p>
					</div>
				</div>
				...
				<div class="col-md-6">
					...
					<div class="image-container">
					  ...
					  <div class="overlay">
					    <div class="text"><a href="pages/sino-si-pepe.php">Siyasatin</a></div>
					  </div>
					</div>
				</div>
