			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
							...
							<form method="post" action="../pages/addvideo.php" enctype="multipart/form-data">


<input type="file" name="fileToUpload"/ class="col-sm-4"><br>
<textarea name="caption" placeholder="Type here"></textarea><br>
<input type="submit" value="Uplaod Video" name="upd"/ class="col-sm-4">
