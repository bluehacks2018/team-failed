		...
		<div class="fh5co-section">
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						<h2>Read this</h2>
						<p>We are reviewing your post. After 1 - 2 hours before the approval</p>

						<p>Any concern. Please <a href="#">Send us report</a></p>
					</div>
					<div class="col-md-6 col-md-push-1">
						<form method="post" action="addvideo.php" enctype="multipart/form-data">
							...
							<div class="form-group">
								<textarea  class="form-control" name="caption" cols="30" rows="10" placeholder="Type here"></textarea>
							</div>
							<div class="form-group">
								<input type="hidden" name="status" value="0">
								<input type="submit" class="btn btn-primary btn-md" value="Upload Video" name="upd"/>
							</div>
						</form>
					</div>
				</div>
